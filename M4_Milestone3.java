...
// CONFLICTE AMB LES FASES 2 I 3 DEL MILESTONE 1 + MILESTONE 2 PER L'ÚS DE LES MATEIXES CLASSES

/* La única diferència d'aquest arxiu amb l'anterior és la inclusió del 'catch' personalitzat
   amb missatge per l'excepció NumberFormatException dins el 'try' que omple la carta,
   quan aquest ja era capturat abans pel 'catch' genèric RuntimeException. */
...
public class M4_Milestone3 {
	public static void main(String args[]) {
		...
		try {
			...
			System.out.println("Preu incorrecte! [Nota: Fes servir el punt com a separador decimal]\n");
